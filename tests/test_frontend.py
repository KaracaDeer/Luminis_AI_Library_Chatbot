...
class TestFrontendComponents(unittest.TestCase):
    ...
    def test_package_json_structure(self):
        ...
        package_path = os.path.join(os.path.dirname(os.path.dirname(__file__)), "src", "frontend", "package.json")
        ...
        try:
            ...
            for field in required_fields:
                self.assertIn(field, package_data, f"Field {field} not found in package.json")

            # Check if scripts exist
            required_scripts = ["dev", "build", "start"]
            for script in required_scripts:
                self.assertIn(script, package_data["scripts"], f"Script {script} not found")
    ...
    def test_tsconfig_structure(self):
        ...
        project_root = os.path.join(os.path.dirname(os.path.dirname(__file__)), "src", "frontend")
        ...
        self.assertTrue(os.path.exists(tsconfig_node_path), "tsconfig.node.json not found")

        # Check file existence (without trying to parse JSON)
        self.assertTrue(os.path.getsize(tsconfig_path) > 0, "tsconfig.json is empty")
        self.assertTrue(os.path.getsize(tsconfig_node_path) > 0, "tsconfig.node.json is empty")
    ...
    def test_tailwind_config(self):
        ...
        tailwind_files = ["src/frontend/tailwind.config.js", "src/frontend/postcss.config.js"]
    ...
    def test_src_structure(self):
        ...
        src_path = os.path.join(os.path.dirname(os.path.dirname(__file__)), "src", "frontend")
    ...
    def test_component_files(self):
        ...
        components_path = os.path.join(os.path.dirname(os.path.dirname(__file__)), "src", "frontend", "components")
        ...
        for component in required_components:
            ...
            self.assertTrue(os.path.exists(component_path), f"Component {component} not found")

    def test_context_files(self):
        """Tests if context files exist"""
        contexts_path = os.path.join(os.path.dirname(os.path.dirname(__file__)), "src", "frontend", "contexts")
        ...
        for context in required_contexts:
            ...
            self.assertTrue(os.path.exists(context_path), f"Context {context} not found")

    def test_store_files(self):
        """Tests if store files exist"""
        stores_path = os.path.join(os.path.dirname(os.path.dirname(__file__)), "src", "frontend", "stores")
    ...
    def test_service_files(self):
        ...
        services_path = os.path.join(os.path.dirname(os.path.dirname(__file__)), "src", "frontend", "services")
        ...
        for service in required_services:
            ...
            self.assertTrue(os.path.exists(service_path), f"Service {service} not found")
    ...
    def test_react_dependencies(self):
        ...
        try:
            ...
            for dep in required_deps:
                self.assertIn(dep, package_data["dependencies"], f"Dependency {dep} not found")

            # Check TypeScript dependencies
            required_dev_deps = ["typescript", "@types/react", "@types/react-dom"]
            for dep in required_dev_deps:
                self.assertIn(dep, package_data["devDependencies"], f"Dev dependency {dep} not found")
    ...
    def test_build_tools(self):
        ...
        try:
            ...
            for tool in build_tools:
                self.assertIn(tool, package_data["devDependencies"], f"Build tool {tool} not found")
